...
const routes: Routes = [
  ...
  { path: '', component: ShellComponent, canActivate: [authGuard], children: [
    ...
    { path: 'clients', component: ClientsComponent }, { path: 'subscriptions', component: ClientsComponent },
    ...
    { path: 'plans', component: PlansComponent }, { path: 'settings', component: SettingsComponent },
